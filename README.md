...
| [`lw-plugins/`](lw-plugins) | LW Plugins family — LW LMS, LW Site Manager 1.5, LW Cookie 1.8, Elállás for WooCommerce, and LW Firewall v1.5.4 (abilities/MCP integration, consent operations, worker/rate-limit compatibility, registration and reset guards, management, and custom-form adapters). |
